        ...
        <div className="relative z-10 p-12 flex flex-col h-full justify-between">
          <div>
            <div className="flex items-center gap-3 text-white">
              ...
              <h2 className="text-2xl font-bold tracking-tight">CSarena</h2>
            </div>
          </div>
          <div className="flex flex-col gap-8">
            <div className="relative w-full aspect-video bg-black/20 backdrop-blur-sm rounded-xl border border-white/10 overflow-hidden shadow-2xl p-6 flex flex-col items-center justify-center group">
              <div
              ...
              ></div>
              <div className="absolute top-4 right-4 bg-green-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg flex items-center gap-1 animate-pulse">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/10">
              ...
              <div className="flex items-center gap-3">
                <div
                  className="size-10 rounded-full bg-white/20 overflow-hidden bg-cover bg-center"
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 lg:p-12 overflow-y-auto">
        <div className="max-w-[420px] w-full flex flex-col gap-6">
          ...
          <div className="flex p-1 bg-[#f0f2f4] dark:bg-slate-800 rounded-lg">
            <button className="flex-1 py-2 px-4 rounded-md bg-white dark:bg-slate-700 shadow-sm text-[#111418] dark:text-white text-sm font-bold transition-all duration-200">
              Log In
            </button>
            <button className="flex-1 py-2 px-4 rounded-md text-[#617589] dark:text-slate-400 hover:text-[#111418] dark:hover:text-white text-sm font-medium transition-all duration-200">
              Sign Up
            </button>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 h-12 px-4 rounded-lg border border-[#dbe0e6] dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors bg-white dark:bg-slate-800 text-[#111418] dark:text-white font-bold text-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#617589] dark:text-slate-500 text-sm font-medium">
          ...
          <form className="flex flex-col gap-5">
            <label className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  className="w-full h-12 rounded-lg border border-[#dbe0e6] dark:border-slate-700 bg-white dark:bg-slate-800 text-[#111418] dark:text-white px-4 pl-11 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all placeholder:text-[#617589] dark:placeholder:text-slate-500"
                  placeholder="student@university.edu"
                  type="email"
                />
                <span className="material-symbols-outlined absolute left-3 top-3 text-[#617589] dark:text-slate-500">
                  mail
                </span>
            ...
            <Link
              className="mt-2 flex w-full cursor-pointer items-center justify-center rounded-lg h-12 bg-primary hover:bg-blue-600 active:bg-blue-700 text-white text-base font-bold leading-normal tracking-[0.015em] transition-colors shadow-lg shadow-blue-500/30"
              to="/achievement"
            >
              Access Your Arena
            </Link>
          </form>
          <div className="pt-6 border-t border-[#f0f2f4] dark:border-slate-800 flex flex-col items-center gap-4">
            <p className="text-xs text-[#617589] dark:text-slate-500 font-medium">
            ...
            <div className="flex gap-6 opacity-60 grayscale hover:grayscale-0 transition-all duration-300">
              <div className="flex items-center gap-1 font-serif text-slate-800 dark:text-slate-300 font-bold text-lg">
          ...
          <p className="text-center text-xs text-[#9aa6b2] dark:text-slate-600 mt-4">
